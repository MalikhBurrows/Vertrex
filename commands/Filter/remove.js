			...
			try {
				...
				message.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setDescription(`<:remove:887696166899306507> **Removed ${toRemove.length} ${toRemove.length == filters.length ? "Filters": `of ${filters.length} Filters! The Rest wasn't a part of the Filters yet!`}**`)
...
/**
 * @INFO
 * Bot Coded by ! MalikhBurrows#5325
 */
